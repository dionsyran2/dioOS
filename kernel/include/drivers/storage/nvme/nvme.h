...
namespace drivers{
    ...
    class nvme_driver_t : public base_driver_t {
        public:
        nvme_driver_t(pci_device_t* hdr);
        ~nvme_driver_t();
        ...
        void _intr_check_admin();
        void _intr_check_queue(nvme_queue_set *queue_set);
        ...
        bool _request_io_queues();
        
        void _create_admin_queues();
        bool _create_io_queues();
        
        int _send_admin_command(nvme_submission_entry_t* entry, uint32_t* result_cdw0 = nullptr);
        ...
        nvme_queue_set *io_queues;

        nvme_namespace_t* namespace_list;
        nvme_namespace_t* last_namespace_entry;
    };
