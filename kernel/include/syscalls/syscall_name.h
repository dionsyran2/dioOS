#pragma once
#include <cstr.h>
// TO BE REMOVED, JUST FOR EARLY DEBUGGING
...
inline void syscall_args(int sysnum, int out[]){
    switch(sysnum){
        ...
        case 93: out[0] = 3; out[1] = 3; out[2] = 3; break;
        case 96: out[0] = 1; out[1] = 1; break;
        case 101: out[0] = 1; out[1] = 1; out[2] = 1; out[3] = 1; break;
        case 102: break;
        case 104: break;
        ...
        case 113: out[0] = 3; out[1] = 3; break;
        case 114: out[0] = 3; out[1] = 3; break;
        case 116: out[0] = 3, out[1] = 1, out[2] = 0; break;
